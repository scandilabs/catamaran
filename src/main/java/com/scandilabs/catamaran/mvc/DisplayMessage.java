 ...
 * 
 * TODO: Consider taking advantage of a temporary ThreadLocal storage to
 * auto-detect the difference between This page and Next page. Then all messages
 * could be saved in the same way, and all GET requests would simply addPending
 * before returning MV.
 * 
 * TODO: Also consider re-implementing as a Session-scoped service, like in
 * connect.scandilabs.com
 * 
 * @author mkvalsvik
 * 
 */
